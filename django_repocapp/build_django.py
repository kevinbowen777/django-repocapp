...
"""
Name: build_django.py
Purpose: Build local Django repositories
...
parser = argparse.ArgumentParser(
    description="Build groups of Django components locally."
)
parser.add_argument(
    "-c",
    "--component",
    ...
    help="Specify an Django component group to build locally.",
)
...
def build_xfce(component, comp_list):
    ...
    print(f"Building the Django {component} group...")
